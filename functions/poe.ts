...
function extractorPrompt(conversation: string): string {
  ...
  return [
    ...
    '- industry maps the company\'s stated line of business to the closest allowed value, and a colloquial word is enough: "tech" / "software" / "SaaS" / "a tech company" -> "tech-software"; "biotech" / "pharma" / "life sciences" / "research" -> "biotech-research"; "hardware" / "industrial" -> "manufacturing"; "retail" / "wholesale" / "e-commerce" -> "retail-wholesale"; a named professional service (law, accounting, consulting, health services, finance, engineering, architecture, performing arts) -> its own value; only when the user says nothing about the line of business -> "unsure". Never omit industry or clarify for it when the user has named one, however briefly.',
    '',
