...
- `amt_iso_optimize` - required: `shares`, `strike`, `fmv`, `filingStatus`, `ordinaryIncome`, `stateCode`, `carryforwardCredit`, `horizon`, `cashReturnRate`, `grantDate`, `hasLeftCompany`. Optional: `terminationDate`, `expectedGrowth`, `volatility`, `volatilityDrag`, `ticker`.
